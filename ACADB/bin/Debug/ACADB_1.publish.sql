...
GO
PRINT N'Creating Table [dbo].[Command]...';
...
GO
PRINT N'Creating Table [dbo].[CommandBaseProduct]...';
...
GO
ALTER TABLE [dbo].[CommandBaseProduct]
    ADD CONSTRAINT [FK_CommandProduct_ToCommand] FOREIGN KEY ([CommandId]) REFERENCES [dbo].[Command] ([Id]);
