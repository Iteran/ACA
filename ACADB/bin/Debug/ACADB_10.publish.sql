...
GO
PRINT N'Creating Procedure [dbo].[BindCustomer]...';
...
AS
	insert into Customers (Name, FirstName, Email, Address, BusinessName, PhoneNumber,UserId) values(@name,@firstName,@email,@address,@businessName,@phoneNumber)
RETURN 0
GO
